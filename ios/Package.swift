...
let package = Package(name: "IControlCore", platforms: [.macOS(.v13), .iOS(.v17)],
    ...
    targets: [.target(name: "IControlCore", path: "IControl", exclude: ["IControlApp.swift", "TouchSurface.swift", "QRScanner.swift", "ControllerModel.swift", "MotionSource.swift", "Info.plist", "Assets.xcassets"], sources: ["ControllerCore.swift"]),
