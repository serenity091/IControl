...
icon.save(assets / "icontrol.ico", sizes=[(16,16),(32,32),(48,48),(64,64),(128,128),(256,256)])

PyInstaller.__main__.run([
    str(ROOT / "desktop.py"), "--name=IControl", "--onefile", "--windowed", "--noconfirm",
    f"--icon={assets / 'icontrol.ico'}", f"--distpath={ROOT / 'dist'}", f"--workpath={ROOT / 'build'}",
